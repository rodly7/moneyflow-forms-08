  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-purple-600 to-blue-600">
      ...
      <div className="px-6 -mt-0 relative z-10">
        <Card className="bg-white/20 backdrop-blur-sm border-0 shadow-xl border-white/30">
      ...
      <div className="px-6 mt-6">
        <div className="bg-white/20 backdrop-blur-sm border-0 shadow-xl rounded-lg border-white/30">
