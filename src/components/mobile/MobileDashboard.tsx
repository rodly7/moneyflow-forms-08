...
const MobileDashboard: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 w-full h-full bg-gradient-to-br from-blue-500 via-blue-600 to-purple-600 overflow-hidden">
      <div className="h-full w-full overflow-y-auto">
        {/* Header avec notification et déconnexion */}
        <div className="text-white p-6 pt-12 safe-area-top">
        ...
        <div className="px-6 mt-6 pb-8 safe-area-bottom">
          <Card className="bg-white/90 backdrop-blur-sm border-0 shadow-xl">
