        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="font-medium text-green-800">Instructions de retrait</span>
            </div>
            <p className="text-sm text-green-700">
              Votre numéro (Mobile Money) va être rechargé de {amount ? `${Number(amount).toLocaleString()} FCFA` : 'montant'} dans 2-5 minutes
            </p>
          </div>
