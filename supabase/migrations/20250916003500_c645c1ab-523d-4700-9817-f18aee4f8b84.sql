-- Improve phone matching in RPC: normalize numbers (remove non-digits) and support leading +
...
BEGIN
  ...
  IF v_phone IS NULL THEN
    RETURN;
  END IF;
  -- Normalize user's phone: keep digits only
