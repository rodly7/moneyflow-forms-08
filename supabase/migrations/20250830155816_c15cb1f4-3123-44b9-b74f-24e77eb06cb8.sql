...
DROP FUNCTION IF EXISTS public.get_agent_quota_status(uuid, date);
...
-- Ajouter une contrainte unique sur agent_id et date pour éviter les doublons
ALTER TABLE agent_daily_quotas 
ADD CONSTRAINT IF NOT EXISTS unique_agent_date 
